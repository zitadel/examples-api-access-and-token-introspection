...
1. [JSON Web Token (JWT) Profile](https://github.com/zitadel/api-access-and-token-introspection/tree/main/api-jwt)
2. [Basic Authentication](https://github.com/zitadel/api-access-and-token-introspection/tree/main/api-basic-authentication)
